...
export const BrideNGroom = () => {
  return (
    <div
      id="about"
      className="max-w-[85rem] mt-24 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto"
    >
      <div
        className={`${oleo.className} mx-auto max-w-lg mb-20 text-center flex flex-col items-center`}
      >
