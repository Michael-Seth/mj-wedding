          ...
          <div className="-m-1.5 overflow-x-auto">
            <div className="p-1.5 min-w-full inline-block align-middle">
              <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-neutral-900 dark:border-neutral-700">
                <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700"></div>
                      ...
                      <td className="h-px w-72 min-w-72 align-top">
                        <a className="block p-6" href="#">
                          ...
                          <span className="block text-sm text-gray-500 dark:text-neutral-500">
                            ...
                            wear it all the time and there is no problem with
                            the fit even though its a mens" hat.
                          </span>
                        </a>
                      </td>
                      <td className="size-px whitespace-nowrap align-top">
