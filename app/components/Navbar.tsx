...
const DarkModeToggler = dynamic(() => import("./DarkModeButton"), { ssr: false });
      ...
      <nav className="mt-4 relative max-w-2xl w-full bg-white border border-gray-200 rounded-[2rem] mx-2 py-2.5 md:flex md:items-center md:justify-between md:py-0 md:px-4 md:mx-auto dark:bg-neutral-900 dark:border-neutral-700">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-end gap-2 md:gap-3 mt-3 md:mt-0 py-2 md:py-0 md:ps-7">
            <Link
              className="py-0.5 md:py-3 px-4 md:px-1  font-medium text-gray-500 focus:outline-none dark:border-neutral-200 dark:text-neutral-200"
              href="/#mj"
              aria-current="page"
            >
              M&amp;J
