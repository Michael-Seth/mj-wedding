...
const FormBtn: React.FC<FormBtnProps> = ({
  ...
  return (
    <>
      <PaystackButton
        {...paymentProps}
        className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#fa688f] text-white hover:bg-[#ff88a0] focus:outline-none focus:bg-[#fa688f] disabled:opacity-50 disabled:pointer-events-none"
        disabled={disabled}
      />
      {/* <Modal /> */}
    </>
